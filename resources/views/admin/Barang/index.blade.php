...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('barang.laporan') }}" class="btn btn-success mb-3" target="_blank">Cetak Laporan PDF</a>
            ...
            <tbody>
                @foreach ($barangs as $barang)
                    <tr>
                        ...
                        <td class="scrollable-description">{{ $barang->deskripsi ?: 'Tidak ada deskripsi' }}</td>
                        <td>{{ $barang->stok }}</td>
                        <td>
    ...
    <style>
        .scrollable-description {
            max-height: 100px; /* Tinggi maksimal kolom deskripsi */
            overflow-y: auto; /* Mengaktifkan scroll vertikal */
            white-space: normal; /* Memastikan teks tidak terpotong dan dapat dibungkus */
        }
    </style>
@endsection
